...
import { buildPanelSummaryTicketLines, buildSaleTicketLines } from "./ejemplo.ticketFormat";
...
export async function printSaleTicket(sales: EjemploSale[], clientName: string | undefined, copies: 0 | 1 | 2 | 3 = 1) {
